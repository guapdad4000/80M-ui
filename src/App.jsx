...
// Technique: fills pixels with random grayscale values, regenerates every
// 3 frames for analog-style flickering. 4% opacity keeps it subtle.
// =====================================================================
const NoiseOverlay = () => {
    ...
    const draw = () => {
      ...
      if (frameRef.current % 3 === 0) {
        ...
        for (let i = 0; i < data.length; i += 4) {
          ...
          data[i + 1] = v;
          data[i + 2] = v;
          data[i + 3] = Math.floor(0.04 * 255); // 4% opacity
        }
  ...
  return (
    <canvas
      ref={canvasRef}
      className="fixed inset-0 z-50 pointer-events-none opacity-[0.4] mix-blend-overlay"
      aria-hidden="true"
    />
  );
};
...
// Technique: inline @keyframes generated per-particle with random
// trajectory, size, and timing for a non-repeating organic drift.
// =====================================================================
